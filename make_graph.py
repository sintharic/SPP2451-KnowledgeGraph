...
jsonfile = 'SPP.json'
vault = 'SPP-KG'
add_info = ['people', 'methods', 'documentation']
# add_info = ['people', 'documentation']
...
if 'people' in add_info: os.makedirs(f'{vault}{os.sep}people', exist_ok=True)
if 'methods' in add_info: os.makedirs(f'{vault}{os.sep}methods', exist_ok=True)
if 'documentation' in add_info: os.makedirs(f'{vault}{os.sep}documentation', exist_ok=True)


# add people to vault
if 'people' in add_info:
...
for project in projects:
  ...
  with open(filename,'w') as file:
    ...
    if ('methods' in project.keys()) and 'methods' in add_info:
      file.write('\n## Methods\n')
    ...
    if ('documentation_media' in project.keys()) and ('documentation' in add_info):
      file.write('\n## Documentation\n')
